...
def export_meta_audience(product_ids: list[str], output_file: str):
    ...
    customers = defaultdict(lambda: {"name": "", "phone_raw": "", "ltv": 0.0, "interacted": False})
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Gera uma lista de público para a Meta Ads lendo CSVs da Hotmart.")
    parser.add_argument("--output", type=str, default="data/meta_audience_export.csv", help="Caminho do CSV de saída")
